...
import 'package:fluty/views/search.dart';
    ...
    return Container(
      child: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("chatroom")
              .doc(widget.chatroomid).collection("chats").orderBy('time').snapshots(),
...
@override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:   timoney(widget.chatroomid),/*Container(
        child: Stack(
          children: [
           timon(),
...
class timoney extends StatefulWidget {
  final String chatroomid;
  timoney(this.chatroomid);
  @override
  _timoneyState createState() => _timoneyState();
}

class _timoneyState extends State<timoney> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder(
