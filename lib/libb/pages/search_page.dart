...
import 'package:fluty/libb/pages/chat_page.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  _joinValueInGroup(String userName, String groupId, String groupName, String admin) async {
    bool value = await DatabaseMethods(uid: _user.uid).isUserJoined(groupId, groupName, userName);
    setState(() {
      _isJoined = value;
    });
  }
  ...
  Widget groupTile(String userName, String groupId, String groupName, String admin){
    ...
    return ListTile(
      ...
      trailing: InkWell(
        onTap: () async {
          await DatabaseMethods(uid: _user.uid).togglingGroupJoin(groupId, groupName, userName);
          if(_isJoined) {
            setState(() {
              _isJoined = !_isJoined;
            });
